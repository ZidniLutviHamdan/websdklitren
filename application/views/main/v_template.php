...
<html lang="en-US">
<head>
	<title>SD NEGERI KLITREN YOGYAKARTA</title>
                    ...
                    <nav class="navbar navbar-default navbar-static-top" id="twd-menu" >
                        ...
                        <div class="navbar-header">
                            ...
                            <!--<img alt="Brand" src="" width=""/>-->
                                 <p style="font-family:Verdana;font-size:25px; padding-top: 20px">SDN KLITREN</p>
...
// DIBIKIN PAKAI DATABASE
Alamat : Jl. Kemakmuran No. 11

RT / RW : 60 / 16

Dusun : Klitren

Desa / Kelurahan : KLITREN

Kecamatan : Kec. Gondokusuman
